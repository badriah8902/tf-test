...
public class EntryResource {
    ...
    public ResponseEntity<EntryDTO> createEntry(@Valid @RequestBody EntryDTO entryDTO) throws URISyntaxException {
        ...
        if (entryDTO.getBlogPositive()) {
            ...
            if ((StringUtils.containsIgnoreCase(entryDTO.getTitle(), "sad")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "fear")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "lonely")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "sad")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "fear")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "lonely")))

                throw new BadRequestAlertException("Invalid Content", ENTITY_NAME, "invalidContent");

        } else {
            if (entryDTO.getEmoji() == Emoji.HAHA || entryDTO.getEmoji() == Emoji.LIKE || entryDTO.getEmoji() == Emoji.WOW)
                throw new BadRequestAlertException("Invalid Emoji", ENTITY_NAME, "invalidEmoji");

            if ((StringUtils.containsIgnoreCase(entryDTO.getTitle(), "love")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "happy")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "trust")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "sad")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "fear")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "lonely")))
                throw new BadRequestAlertException("Invalid Content", ENTITY_NAME, "invalidContent");
    ...
    public ResponseEntity<EntryDTO> updateEntry(@Valid @RequestBody EntryDTO entryDTO) throws URISyntaxException {
        ...
        if (entryDTO.getBlogPositive()) {
            ...
            if ((StringUtils.containsIgnoreCase(entryDTO.getTitle(), "love")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "happy")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getTitle(), "trust")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "love")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "sad")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "fear")) ||
                (StringUtils.containsIgnoreCase(entryDTO.getContent(), "lonely")))
                throw new BadRequestAlertException("Invalid Content", ENTITY_NAME, "invalidContent");
